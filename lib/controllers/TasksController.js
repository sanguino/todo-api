...
class TasksController {
  ...
  static async retrieveAllTasks(req, res, next) {
    ...
    let data;
    try {
      data = await dataInterface.retrieveAllTasks(req.username);
    } catch (err) {
  ...
  static async retrieveTasksById(req, res, next) {
    ...
    let data;
    try {
      data = await dataInterface.retrieveTasksById(req.username, {
        id: req.params.id,
      });
    } catch (err) {
      return next(Boom.internal(err));
  ...
  static async createTask(req, res, next) {
    ...
    let data;
    try {
      data = await dataInterface.createTask(req.username, {
        id: req.body.id,
        text: req.body.text,
      });
    } catch (err) {
  ...
  static async updateTask(req, res, next) {
    ...
    let data;
    try {
      data = await dataInterface.updateTask(req.username, {
        id: req.params.id,
  ...
  static async deleteTask(req, res, next) {
    ...
    let data;
    try {
      data = await dataInterface.deleteTask(req.username, {
        id: req.params.id,
      });
    } catch (err) {
      return next(Boom.internal(err));
